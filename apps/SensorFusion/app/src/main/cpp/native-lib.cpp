...
public:
  ...
  void pause() { ASensorEventQueue_disableSensor(accelerometerEventQueue, accelerometer); }
...
static sensorgraph gSensorGraph;

extern "C" {
JNIEXPORT void JNICALL Java_com_example_sensorfusion_MainActivity_init(JNIEnv* env, jobject /*this*/,
                                                                       jobject assetManager) {
  AAssetManager* nativeAssetManager = AAssetManager_fromJava(env, assetManager);
  gSensorGraph.init(nativeAssetManager);
}

JNIEXPORT void JNICALL Java_com_example_sensorfusion_MainActivity_surfaceCreated(JNIEnv* /*env*/, jobject /*this*/) {
  gSensorGraph.surfaceCreated();
}

JNIEXPORT void JNICALL Java_com_example_sensorfusion_MainActivity_surfaceChanged(JNIEnv* /*env*/, jobject /*this*/,
                                                                                 jint width, jint height) {
  gSensorGraph.surfaceChanged(width, height);
}

JNIEXPORT void JNICALL Java_com_example_sensorfusion_MainActivity_drawFrame(JNIEnv* /*env*/, jobject /*this*/) {
  gSensorGraph.update();
  gSensorGraph.render();
}

JNIEXPORT void JNICALL Java_com_example_sensorfusion_MainActivity_pause(JNIEnv* /*env*/, jobject /*this*/) {
  gSensorGraph.pause();
}

JNIEXPORT void JNICALL Java_com_example_sensorfusion_MainActivity_resume(JNIEnv* /*env*/, jobject /*this*/) {
  gSensorGraph.resume();
}
}

extern "C" JNIEXPORT jstring JNICALL Java_com_example_sensorfusion_MainActivity_stringFromJNI(JNIEnv* env,
                                                                                              jobject /* this */) {
