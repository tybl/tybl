...
bool Money::operator==(Money const& o) const { return m_value == o.m_value; }
...
Money::MoneyType Money::get_money_type() const { return std::to_string(m_value); }

void Money::set_money_type(MoneyType const& v) { m_value = std::stoll(v); }
...
Money operator+(Money a, Money const& b) { return a += b; }
