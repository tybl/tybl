...
bool money_t::operator==(const money_t& other) const { return value == other.value; }

std::ostream& operator<<(std::ostream& out, const money_t& a) { return out << a.to_string(); }

ledger::money_t operator+(money_t lhs, const money_t& rhs) { return lhs += rhs; }
