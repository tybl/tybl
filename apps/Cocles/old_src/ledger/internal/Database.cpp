...
TableView<AccountType> Database::get_account_type_table() const { return TableView<AccountType>(account_type_table); }
...
TableView<Account> Database::get_account_table() const { return TableView<Account>(account_table); }

AccountEntry Database::new_account() { return AccountEntry(account_table.allocate()); }
...
void Database::delete_account(AccountEntry record) { account_table.free(record.get_id()); }
...
TableView<Transaction> Database::get_transaction_table() const { return TableView<Transaction>(transaction_table); }

TransactionEntry Database::new_transaction() { return TransactionEntry(transaction_table.allocate()); }
...
void Database::delete_transaction(TransactionEntry record) { transaction_table.free(record.get_id()); }
...
TableView<Adjustment> Database::get_adjustment_table() const { return TableView<Adjustment>(adjustment_table); }

AdjustmentEntry Database::new_adjustment() { return AdjustmentEntry(adjustment_table.allocate()); }
...
void Database::delete_adjustment(AdjustmentEntry record) { adjustment_table.free(record.get_id()); }
