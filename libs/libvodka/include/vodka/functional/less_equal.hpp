...
struct less_equal {
  ...
  [[nodiscard]] constexpr auto operator()(T const& p_lhs, T const& p_rhs) const -> bool { return p_lhs <= p_rhs; }
};
...
struct less_equal<void> {
  ...
  [[nodiscard]] constexpr auto operator()(TypeL&& p_lhs, TypeR&& p_rhs) const
