...
[[nodiscard]] constexpr _EnableByteOverload<_Integer> operator<<(byte __lhs, _Integer __shift) noexcept {
...
[[nodiscard]] constexpr auto to_integer(byte b) noexcept -> _Integer {
