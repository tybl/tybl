...
[[nodiscard]] constexpr auto gcd(TypeM m, TypeN n) -> common_type_t<TypeM, TypeN> {
  ...
  return static_cast<CommonType>(gcd(static_cast<CommonUnsignedType>(__ct_abs<CommonType, TypeM>()(m)),
                                     static_cast<CommonUnsignedType>(__ct_abs<CommonType, TypeN>()(n))));
}

template <typename Type>
[[nodiscard]] constexpr auto gcd<Type, Type>(Type m, Type n) -> Type {
