...
struct decimal_t {
  decimal_t();
  bool operator==(const decimal_t& other) const { return ((m_value == other.m_value) && (m_factor == other.m_factor)); }
  bool operator!=(const decimal_t& other) const { return !operator==(other); }
  ...
  decimal_t& operator+=(decimal_t other) {
    ...
    m_value =
        m_value * (fewer ? other.m_factor / m_factor : 1) + other.m_value * (fewer ? 1 : m_factor / other.m_factor);
